function FakeVolumesInlineOptionsModule(containerElement) {
...
FakeVolumesInlineOptionsModule.prototype.loadModule = function() {
    var _this = this;

    _this.loadVolumes();
};

FakeVolumesInlineOptionsModule.prototype.loadInteractiveStyles = function() {
    var _this = this;
...
FakeVolumesInlineOptionsModule.prototype.loadVolumes = function() {
    var _this = this;
    ...
    $.get('/modules/fake_volumes_inline_options/templates/volume_template.html', null,
        function(data) {
...
FakeVolumesInlineOptionsModule.prototype.loadClickEvents = function() {
    var _this = this;
...
FakeVolumesInlineOptionsModule.prototype.getVolumeByGuid = function(guid) {
    var _this = this;
...
FakeVolumesInlineOptionsModule.prototype.remove = function() {
    var _this = this;
